...
import org.testng.annotations.BeforeGroups;
   ...
   ////////    BROWSER IS LAUNCHED 3 TIMES FOR 3 TEST CASES BCOZ OF METHOD ANNOTATIONS  ///////////
   /////////   ORDER OF TEST CASE EXECUTION IS RANDOM    ///////////////////////

@Test (groups= {"vijaya"})
public class TNGSignInVerifyMethodAnnotation {
  ...
  public void verifyUserWithValidUIdBlankPwd() throws InterruptedException, IOException  {
	  ...
	  PageFactory.initElements(driver,SignInPageObjects.class );
		 ...
		 System.out.println("############## Valid Id    Blank Pwd statrs   ########TNGSignInVerifyMethodAnnotation####");
		 ...
		 System.out.println("############## Valid Id    Blank Pwd ends   ########TNGSignInVerifyMethodAnnotation####");
...
void verifyUserWithvalidUIdPwd() throws InterruptedException, IOException {
  ...
  //1.Verify user signin and password   START
	 System.out.println("############## Valid Id    Valid Pwd statrs   #######TNGSignInVerifyMethodAnnotation#####");
    ...
    //1.Verify user signin and password   ENDED
	 System.out.println("############## Valid Id    Valid Pwd Ends   ########TNGSignInVerifyMethodAnnotation####");
...
public void verifyUserWithvalidUIdInvalidPwd() throws InterruptedException, IOException {
 ...
 System.out.println("############## Valid Id   In Valid Pwd statrs   #######TNGSignInVerifyMethodAnnotation#####");
...
Thread.sleep(2000);
 System.out.println("############## Valid Id   In Valid Pwd Ends   ########TNGSignInVerifyMethodAnnotation####");
